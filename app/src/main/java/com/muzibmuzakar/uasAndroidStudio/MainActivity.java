...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private ArrayList<ModelPelajaran> arrayModelPelajarans;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(SharedPrefManager.getInstance(this).isLoggedIn()){
            ...
            FloatingActionButton fab_tambah = findViewById(R.id.fab_tambah_pelajaran);
    ...
    public void MuatData() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, response -> {
            try {
                ...
                Type typeModelBarang = new TypeToken<ArrayList<ModelPelajaran>>() {
                }.getType();
                // menerapkan ke model class menggunakan GSON
                // mengkonversi JSON ke java object
                arrayModelPelajarans = new Gson().fromJson(response, typeModelBarang);

                // memanggil kontruktor adapter dan mengimplementasikannya
                adapter = new RecyclerViewAdapter(MainActivity.this, arrayModelPelajarans);
        ...
        AppController.getInstance().addToQueue(request, "data_pelajaran");
    }
